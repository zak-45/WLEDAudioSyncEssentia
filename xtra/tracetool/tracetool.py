...
LOG_FILE = root_path("log/trace_log.txt")
HTML_LOG_FILE = root_path("log/trace_log.html")
CONFIG_PATH = root_path("config/tracetool.ini")
...
ALLOWED_PATHS = [
    os.path.abspath(root_path(path))
...
def trace_calls(frame, event, arg):
    ...
    rel_path = os.path.relpath(filename, root_path('')).replace('\\', '/')
